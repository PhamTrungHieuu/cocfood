        ...
        if (valueEdit) {
            try {
                ...
                if (response.data.success) {
                    toast.success(`Thay đổi ${labelEdit} thành công`, { autoClose: 2000 });
                    btnCancel()
                } else {
                    toast.error(`Thay đổi ${labelEdit} không thành công`, { autoClose: 2000 });
                    btnCancel()
                }
            } catch (error) {
                console.error('Error fetching data:', error);
                ...
                <div>
                    ...
                    {userData && <div className="profile-box">
                        ...
                        <div className="profile-img">
                            ...
                            <button style={{ marginLeft: '45%' }} className="profile-row-edit" onClick={() => changeUserAvatar(userData._id, 'address', userData.address, 'Ảnh đại diện')}> Thay đổi</button>
                        </div>
                    </div>}
                </div>
