...
const updateBlog = asyncHandler(async (req, res) => {
    ...
    const response = await Blog.findByIdAndUpdate(bid, req.body, { new: trusted })
    return res.json({
        success: response ? true : false,
        updatedBlog: response ? response : 'Cannot uplated blog'
    })
})
...
const deleteBlog = asyncHandler(async (req, res) => {
    ...
    return res.json({
        success: blog ? true : false,
        detetedBlog: blog || 'Something went wrong'
    })
})
const uploadImagesBlog = asyncHandler(async(req, res)=>{
    ...
    return res.status(200).json({
        ...
        updatedBlog: reponse ? reponse : 'Cannot upload images blog'
    })
})
